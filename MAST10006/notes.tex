...
substitution is
\[\int f(g(x))g^\prime(x)\dx = \int f(u)\frac{du}{dx}\dx 
= \int f(u) \:\mathrm{d}u\]
An example
...
\[x = 5\cosh(\theta) \Rightarrow \frac{dx}{d\theta} = 5\sinh(\theta)\]
