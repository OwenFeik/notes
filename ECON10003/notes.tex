...
\begin{econplot}{\(Q\)}{\(P\)}
    \addplot[blue, ultra thick] {5-x} node[above right, pos = 0.6] {\(QD\)};
    \addplot[red, ultra thick, ->] {x} node[above left, pos = 0.9] {\(QS\)};
    \addplot[black, ultra thick, dashed] coordinates {(0, 2)(5, 2)}
    node[right] {\(P_W\)};
    \node[circle, fill, inner sep = 2pt] at (axis cs: 2, 2) {};
    \node[below right] at (axis cs: 2, 2) {\(Q_d\)};
    \node[circle, fill, inner sep = 2pt] at (axis cs: 3, 2) {};
    \node[below left] at (axis cs: 3, 2) {\(Q_t\)};
    \node[circle, fill, inner sep = 2pt] at (axis cs: 2.5, 2.5) {};
...
\begin{econplot}{\(I/S\)}{\(r\)}
    \addplot[blue, ultra thick, ->, domain = {0:3}] {5 * ((x + 1)^0.5 - 1)};
    \addplot[red, ultra thick] {5 - 0.2 * (x + 1)^2};
    \addplot[black, ultra thick, dashed] coordinates {(0, 2)(4, 2)}
    node[right] {\(r_W\)};
    ...
    \node[above left] at (axis cs: 0.96, 2) {\(S_W\)};
    \node[circle, fill, inner sep = 2pt] at (axis cs: 2.873, 2) {};
    \node[above right] at (axis cs: 2.873, 2) {\(I_W\)};
\end{econplot}
